...
ActiveRecord::Schema.define(version: 2021_10_15_124748) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.index ["slug", "published"], name: "index_posts_on_slug_and_published", unique: true
  ...
  create_table "subscriptions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["author_id", "user_id"], name: "index_subscriptions_on_author_id_and_user_id", unique: true
